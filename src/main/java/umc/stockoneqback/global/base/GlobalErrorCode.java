...
public enum GlobalErrorCode implements ErrorCode {
    ...
    NOT_SUPPORTED_MEDIA_TYPE_ERROR(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "GLOBAL_004", "잘못된 미디어 타입입니다."),
    INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "GLOBAL_005", "내부 서버 오류입니다."),
    INVALID_ENUM(HttpStatus.BAD_REQUEST, "GLOBAL_006", "Enum 타입으로 변경할 수 없습니다."),
    ;
