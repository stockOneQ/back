...
public enum BaseResponseStatus {
     ...
     * 400 : 요청 실패
     */
    BAD_REQUEST(HttpStatus.BAD_REQUEST, "REQUEST_001", "입력값을 확인해주세요."),
    ...
    UNAUTHORIZED(HttpStatus.UNAUTHORIZED, "REQUEST_005", "로그인이 필요합니다."),
    ...
    BaseResponseStatus(HttpStatus status, String errorCode, String message) { //BaseResponseStatus 에서 각 해당하는 코드를 생성자로 맵핑
        this.status = status;
