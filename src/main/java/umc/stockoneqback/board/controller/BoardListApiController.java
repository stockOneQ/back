...
public class BoardListApiController {
    ...
    @GetMapping("")
    public ResponseEntity<CustomBoardListResponse<BoardList>> boardList(@ExtractPayload Long userId,
    ...
    @GetMapping("/my")
    public ResponseEntity<CustomBoardListResponse<BoardList>> myBoardList(@ExtractPayload Long userId,
                                                                          @RequestParam(value = "page", defaultValue = "0", required = false) int page,
                                                                          @RequestParam(value = "sort", required = false, defaultValue = "최신순") String sortBy,
                                                                          @RequestParam(value = "search", required = false, defaultValue = "제목") String searchBy,
                                                                          @RequestParam(value = "word", required = false, defaultValue = "") String searchWord) {
    ...
    @DeleteMapping("/my")
    public ResponseEntity<Void> deleteMyBoard(@ExtractPayload Long userId, @RequestParam List<Long> boardId) {
