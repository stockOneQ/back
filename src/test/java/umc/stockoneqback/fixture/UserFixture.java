...
public enum UserFixture {
    ...
    ANNE("anne@gmail.com", "StrongPass!123", "앤", LocalDate.of(1995, 5, 12), "01098765432", "매니저"),
    WEEZ("weez@yahoo.com", "SecurePass456", "위즈", LocalDate.of(1988, 9, 25), "01056781234", "슈퍼바이저"),
